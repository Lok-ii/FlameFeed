...
import { searchUsers, setLoading } from "../../Redux/searchSlice";
      ...
      <div className="text-white w-[100%] border-b-[1px] border-gray-800 p-6 flex flex-col gap-8">
        ...
        <div className="w-[100%] flex items-center justify-center">
          <div className="relative w-[100%] min-w-[200px] h-12">
            <div
              className="absolute grid w-5 h-5 place-items-center text-gray-400 top-2/4 right-3 -translate-y-2/4 cursor-pointer"
              onClick={() => {
            ...
            {searchResults.length !== 0 &&
              searchResults.map((user) => {
                return (
                  <div
                    key={user.id}
                    className="userProfile flex items-center gap-4"
                  >
